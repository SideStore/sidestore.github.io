...
let setupStepContents = [
  ...
  () =>
    `<b>To get started, you'll need:</b><ul class="list-disc list-inside"><li>${osW(
      ...
      `Then, open the downloaded AltServer zip file and extract it. Then copy <code>AltServer.app</code> to your Applications folder. Now, open AltServer (it should appear as an icon in the menu bar).`,
