  ...
  //pairing file
                                                                                                                                                                                                                                                        (os) =>
                                                                                                                                                                                                                                                                                                        `<b>Follow these steps to pair your device:</b><li>Extract <code>jitterbugpair.zip</code> (if applicable).<a class="glink" target="_blank" href="https://support.apple.com/en-ca/guide/iphone/iph14a867ae/ios">Set a passcode for your device</a> if you don't already have one and ensure that your device is still connected to your computer via cable.</li> <ul class="list-disc list-inside"><li> Open your device to its homescreen. ${osW(
                                                                                                                                                                                                                                                                                                          'Then, execute <code>jitterbugpair</code> (it should have a black and green icon) by double-clicking it or right-clicking it and selecting "open."</li><li>JitterbugPair will then generate and save a <b>pairing file</b> to your user home folder. This pairing file will have the file exentension <code>mobiledevicepairing.</code></li>',
...
<li>Zip this pairing file and transfer it to your device via AirDrop, iCloud/One/Google Drive, emailing it to yourself, or any other method.</li>
