...
let setupStepContents = [
  ...
  () =>
    ...
    )}</li><li>An Apple ID</li><li>An Internet connection</li><li>An iPhone or iPad with iOS 14/iPadOS 14 or later</li></ul><br>On your computer, download the following:<a class="btn-fill" target="_blank" href="${osW(
      ...
      'https://cdn.altstore.io/file/altstore/altinstaller.zip'
          ...
          <a class="btn-fill" target="_blank" href="${osW(
            ...
            'https://github.com/sidestore/sidestore/releases/latest/download/sidestore.ipa'
                ...
                <a class="btn-fill" target="_blank" href="${osW(
                  'https://github.com/SideStore/SideStore-Docs/releases/download/need-a-place-to-put-jittterbug/jitterbugpair',
  ...
  (os) =>
    `<b>Follow these steps to install SideStore:</b><ul class="list-disc list-inside"><li>Plug your device into your computer via a cable.</li><li>If a prompt appears, tap "trust" and type in your passcode.</li><li>Launch AltServer and, ${osW(
  ...
  //pairing file
                                                                                                                                                                                                                                                        (os) =>
                                                                                                                                                                                                                                                                                                        `<b>Follow these steps to pair your device:</b><li>Extract <code>jitterbugpair.zip</code> (if applicable).<a class="glink" target="_blank" href="https://support.apple.com/en-ca/guide/iphone/iph14a867ae/ios">Set a passcode for your device</a> if you don't already have one and ensure that your device is still connected to your computer via cable.</li> <ul class="list-disc list-inside"><li> Open your device to its homescreen. ${osW(
                                                                                                                                                                                                                                                                                                          'Then, execute <code>jitterbugpair</code> (it should have a black and green icon) by double-clicking it or right-clicking it and selecting "open". The first time you run the tool, you will get a prompt for your passcode on your secondary device. Type it in, then keep the screen on and unlocked and run the tool again.</li><li>JitterbugPair will then generate and save a <b>pairing file</b> to your user home folder. This pairing file will have the file exentension <code>.mobiledevicepairing</code>.</li>',
                                                                                                                                                                                                                                                                                                          'Then, in File Explorer, locate <code>jitterbugpair.exe</code> and execute it by double-clicking it or right-clicking it and selecting "open". The first time you run the tool, you will get a prompt for your passcode on your secondary device. Type it in, then keep the screen on and unlocked and run the tool again.<li>JitterbugPair will then generate a <b>pairing file</b> within the same folder. This pairing file will have the file exentension <code>.mobiledevicepairing</code>. If no file generates, try running JitterbugPair as an administrator or follow steps 7-9 listed <a class="glink" target="_blank" href="https://docs.sidestore.io/docs/installation/pairing-file">here</a>.</li>')}</li>
                                                                                                                                                                                                                                                                                                          
<li>Compress the file into a .zip folder and transfer it to your device via AirDrop, iCloud/One/Google Drive, email, or another preferred method.</li>
<br>In the Files app, longpress on your zipped pairing file and select "uncompress". Then, locate and launch the SideStore app and select "OK" when prompted.<li>If you cannot find the SideStore app you may need to restart your device to make it appear.</li>Select your (now unzipped) pairing file and SideStore will be paired!<li>Note that if you update your iDevice your pairing file will become invalid and you'll have to go through this process again.</li><li>To reset the pairing file SideStore uses, tap <code>Reset Pairing File</code> in the Settings section of the SideStore app.</li>`,
  // StosVPN (previously WireGuard)
  () =>
    `On your device, download the StosVPN app.<a class="btn-fill" target="_blank" href="https://apps.apple.com/us/app/stosvpn/id6744003051">Download StosVPN</a>Then, enable the StosVPN VPN. You'll have to enable this VPN whenever you wish refresh or install apps in SideStore. StosVPN does not connect to an external server, but rather allows your device to communicate with itself.<br><br>If left enabled, SideStore will attempt to refresh your sideloaded apps in the background when necessary.`,
  //finishing up
  () =>
    `Now to finish the process: <ul class="list-disc list-inside"><li>Open SideStore and sign in with the same Apple ID you used to install SideStore.</li><li>Go to the Apps tab and refresh the SideStore app by tapping on the green day counter or selecting <code>Refresh All.</code> You <b>must</b> do this whenever you install SideStore, including on all devices when (re)installing SideStore on other devices using the same Apple ID using AltServer. Not doing this might cause errors, leading to early expiration.</li></ul>
